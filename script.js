...
function init() {
    try {
        ...
        if (loaderTitle) {
          loaderTitle.textContent = `Loading Planetoid v.09 Alpha...`;
        }

        logDebug('Planetoid v.09 Alpha loading...');
...
if (versionDisplay) {
    versionDisplay.textContent = 'Planetoid v.09 Alpha';
}
// 8.00.01
